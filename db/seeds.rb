...
Question.create!(quiz_id: 7,body: "以下メソッドの実行結果として正しいものはどれ")
Question.find(69).image.attach(io: File.open("#{Rails.root}/db/fixtures/question_68.png"), filename:"question_68.png")
...
Choice.create!(question_id: 69,answer: true,body: '["a","b","c",4]')
Choice.create!(question_id: 69,answer: false,body: '["a","b","c","d",3,4]')
Choice.create!(question_id: 69,answer: false,body: '[3,4]')
